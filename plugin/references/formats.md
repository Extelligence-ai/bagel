...
|---|---|---|---|
| ROS 2 bag | `.mcap`, `.db3` dirs | `ros2-kilted` / `ros2-jazzy` / `ros2-iron` (match the bag's distro) | — |
| ROS 1 bag | `.bag` | `ros1` | — |
...
| ASAM MDF | `.mf4` | `iot` | — |
| CSV / JSON / Parquet | files or partitioned dirs | `arrow` (lightest) | optional timestamp column/format args |
