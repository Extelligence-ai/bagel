...
Then start the container for your data format (see [Quickstart](#️-quickstart)) —
the plugin connects to `http://localhost:8000/sse` by default. Any other MCP
client can discover the same workflows server-side via the
`list_agent_capabilities` tool.
